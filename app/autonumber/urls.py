...
urlpatterns = patterns('app.autonumber.views',
    ...
    #--------------------------------------------------------------------------------
    url(r'^(?P<type>\d+)/gaotingzi/add/$', 'autonumber.AddTingGaoZi', name='AddTingGaoZi'),
    url(r'^(?P<type>\d+)/gaotingzi/list/$', 'autonumber.ListTingGaoZi', name='ListTingGaoZi'),
    url(r'^(?P<type>\d+)/gaotingzi/edit/(?P<ID>\d+)/$', 'autonumber.EditTingGaoZi', name='EditTingGaoZi'),
    url(r'^(?P<type>\d+)/gaotingzi/delete/(?P<ID>\d+)/$', 'autonumber.DeleteTingGaoZi', name='DeleteTingGaoZi'),
    #--------------------------------------------------------------------------------
