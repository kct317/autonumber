...
autoviewspath = 'autonumber.views.'
urlpatterns = [
    # Examples:
	...
	url(r'^test/$', 'autonumber.views.test', name='test'), # http://127.0.0.1:8000/test
	url(r'^foo1/(?P<Month>\d+)/(?P<Day>\d+)/$', autoviewspath+'foo', {'func':autoviews.view1}), # http://127.0.0.1:8000/foo1/7/12
	url(r'^foo2/(?P<Month>\d+)/(?P<Day>\d+)/$', autoviewspath+'foo', {'func':autoviews.view2}), # http://127.0.0.1:8000/foo2/7/12
